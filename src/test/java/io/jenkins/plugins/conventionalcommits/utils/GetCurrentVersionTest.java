...
public class GetCurrentVersionTest {
    ...
    public void testMavenProjectVersion() throws IOException, InterruptedException {
        ...
        GetCurrentVersion currentVersion = new GetCurrentVersion();
    ...
    @Test
    public void getCurrentVersion_NoProjectWithTag() throws IOException, InterruptedException {
    ...
    @Test
    public void getCurrentVersion_NoProjectNoTag() throws IOException, InterruptedException {
